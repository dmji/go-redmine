...
// Enumerations - Status: Alpha, Availablity: 2.2
//
...
func newEnumerations(sdkConfig sdkConfiguration) *Enumerations {
	return &Enumerations{
		sdkConfiguration: sdkConfig,
	}
}

// GetIssuePriorities - List issue priorities
//
...
func (s *Enumerations) GetIssuePriorities(ctx context.Context, format components.Format, xRedmineSwitchUser *string, opts ...operations.Option) (*operations.GetIssuePrioritiesResponse, error) {
	...
	res := &operations.GetIssuePrioritiesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetIssuePrioritiesResponseBody
...
// GetTimeEntryActivities - List time entry activities
//
...
func (s *Enumerations) GetTimeEntryActivities(ctx context.Context, format components.Format, xRedmineSwitchUser *string, opts ...operations.Option) (*operations.GetTimeEntryActivitiesResponse, error) {
	...
	res := &operations.GetTimeEntryActivitiesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetTimeEntryActivitiesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// GetDocumentCategories - List document categories
//
...
func (s *Enumerations) GetDocumentCategories(ctx context.Context, format components.Format, xRedmineSwitchUser *string, opts ...operations.Option) (*operations.GetDocumentCategoriesResponse, error) {
	...
	res := &operations.GetDocumentCategoriesResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetDocumentCategoriesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
