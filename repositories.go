...
// Repositories - Undocumented
type Repositories struct {
	sdkConfiguration sdkConfiguration
}

func newRepositories(sdkConfig sdkConfiguration) *Repositories {
	return &Repositories{
...
func (s *Repositories) AddRelatedIssue(ctx context.Context, request operations.AddRelatedIssueRequest, opts ...operations.Option) (*operations.AddRelatedIssueResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/projects/{project_id}/repository/{repository_id}/revisions/{revision}/issues.{format}", request, nil)
	if err != nil {
	...
	res := &operations.AddRelatedIssueResponse{
...
func (s *Repositories) RemoveRelatedIssue(ctx context.Context, request operations.RemoveRelatedIssueRequest, opts ...operations.Option) (*operations.RemoveRelatedIssueResponse, error) {
	...
	res := &operations.RemoveRelatedIssueResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
