...
// Trackers - Status: Alpha, Availablity: 1.3
//
...
func newTrackers(sdkConfig sdkConfiguration) *Trackers {
	return &Trackers{
...
func (s *Trackers) GetTrackers(ctx context.Context, format components.Format, xRedmineSwitchUser *string, opts ...operations.Option) (*operations.GetTrackersResponse, error) {
	...
	res := &operations.GetTrackersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetTrackersResponseBody
