...
// Redmine - Redmine API: Unofficial OpenAPI specification for the Redmine API.
//
...
type SDKOption func(*Redmine)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Redmine) {
...
func New(opts ...SDKOption) *Redmine {
	sdk := &Redmine{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
